...
<!-- Favicons -->
  ...
  <link href="https://www.codegreenback.com/public/001/css/style.css?id=003" rel="stylesheet">
	...
	<input type='hidden' id='username_client' value='<?php  echo $_SESSION['user']; ?>'>
        ...
        <div class="col-lg-6 col-12 slidee">
          <div class="sliderr">
            ...
            <div class="slidesr">
	      <div id="sliderr-1">
		<a href="https://www.codegreenback.com/events/register.php?id=5f54fdbb1c549">
	       <img class="img11"src="https://www.codegreenback.com/public/001/img/10.png">
              ...
              <div id="sliderr-4">
                <img class="img11"src="https://www.codegreenback.com/public/img/001/fn.png">
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              ...
              <div class="col-lg-12 cta-btn-container text-center">
                <a class="cta-btn align-middle" href="https://www.codegreenback.com/events/register.php?id=5f54fdbb1c549">REGISTER</a>
              </div>
            </div>
          </div>
