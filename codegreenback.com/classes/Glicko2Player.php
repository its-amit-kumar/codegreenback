...
class Glicko2Player {
	...
	function __construct($rating = 1500, $rd = 350, $volatility = 0.06, $mu = null, $phi = null, $sigma = null, $systemconstant = 0.9) {
		// Step 1
		$this->rating = $rating;
		$this->rd = $rd;
		// volatility
	...
	function AddMatches($M) {
		...
		// return array( 'point' => ( 173.7178 * $mu_p ) + 1500, 'rd' => 173.7178 * $phi_p, 'mu' => $mu_p, 'phi' => $phi_p, 'sigma' => $sigma_p );
		return array( 'point' => ( 173.7178 * $mu_p ) + 1500, 'rd' => 173.7178 * $phi_p);
	}
